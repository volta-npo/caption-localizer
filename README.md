...
**Marketing & Content** · **Repo 23/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/23-caption-localizer/) · [Report an issue](https://github.com/volta-npo/23-caption-localizer/issues) · [Volta](https://voltanpo.org)
...
**Caption Localizer** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Marketing pods drafting social posts quickly turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
| 2 | **Local reference prompts** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/23-caption-localizer.git
