export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Neighborhood Caption Lab",
    "Operational table: Caption drafts",
  ...
  "releaseChecklist": [
    ...
    "Local Fit reaches production threshold",
    "CTA Coverage is documented with evidence",
    "Translation Review has no unresolved blocker",
    "Platform captions verified",
    "Bilingual variants verified",
    "Hashtag sets verified"
  ],
  "operations": [
